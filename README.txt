    SC 0.2 ----> Control supercollider sound server from Python
    ixi software - June 2008
...
To do:
- detach scsynth process launch from sc.start ? should it be optional?
- include scosc and scsynth within the sc library?
